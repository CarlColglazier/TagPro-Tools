...
function loadSettings() {
    'use strict';
    tagpro.tools.global.data.get('starter settings', 'settings', function (message) {
        if (!message) {
            return;
        }
...
function loadMenu() {
    'use strict';
    tagpro.tools.global.data.emit('menu request','menu request', function(menu_settings) {
...
function loadTextures() {
    'use strict';
    tagpro.tools.global.data.get('tools textures', 'textures', function (message) {
        if (!message) {
            return;
        }
        addBackground(message.background);
        tagpro.tools.textures = message;
    });
}
